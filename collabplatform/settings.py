...
SECRET_KEY = 'django-insecure-r-9r#jwz+tn=&g_1b$q9s5jlr_f3gj6q4)u!l#1k1m8-t#1=$$'
...
ROOT_URLCONF = 'collabplatform.urls'
...
WSGI_APPLICATION = 'collabplatform.wsgi.application'
